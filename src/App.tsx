...
export default function App() {
  ...
  const { isAwake, status, feed, volume, mood, interruptionCount, cameraActive, awaken, sleep, playWelcomeScript } = useLiveAPI(personalityConfig);
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative">
        ...
        <div className="absolute bottom-20 flex flex-col items-center gap-6">
          ...
          <div className="flex gap-4">
            ...
            {isAwake && (
              <button
                onClick={playWelcomeScript}
                className="px-8 py-3.5 rounded-full bg-[#a855f7] hover:bg-[#a855f7]/90 text-white text-sm font-semibold transition-all shadow-[0_0_30px_rgba(168,85,247,0.3)] hover:shadow-[0_0_40px_rgba(168,85,247,0.5)] border border-purple-500/30"
              >
                Welcome Speech
              </button>
            )}
