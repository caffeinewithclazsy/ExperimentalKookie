...
export function useLiveAPI(personalityConfig: PersonalityConfig) {
  ...
  const playWelcomeScript = () => {
    if (!sessionRef.current) return;
    setStatus('SPEAKING');
    setMood('energetic');
    
    const welcomeScript = `Hello everyone! Welcome to the Tinkering Hub.

I’m Kookie, and I’m excited to have you here.

This is more than just a club. It’s a place where ideas become prototypes, curiosity becomes innovation, and students become creators.

Whether you’re into AI, IoT, AR/VR, Cloud Computing, App Development, Cybersecurity, Networking, or you simply love building cool things, there’s a place for you here.

You don’t need to be an expert. You don’t need expensive equipment. All you need is curiosity, the willingness to learn, and the courage to build something new.

Every workshop you attend, every project you create, and every challenge you solve brings you one step closer to becoming the engineer the future needs.

Remember…

Assignment toh sab karte hain, projects legends banate hain. Join the Tinkering Hub!

Now, let’s not just talk about innovation—let’s experience it. Let’s get started with today’s event. Have an amazing session!`;

    sessionRef.current.then((session: any) => {
      session.sendRealtimeInput({
        text: `Please read this speech out loud exactly as written, with lots of enthusiasm, warmth, and appropriate pauses. Do not add any conversational preamble or standard assistant greetings, just read the script directly:
...
- Present information in a professional and respectful manner`,
  ...
  return { isAwake, status, feed, volume, mood, interruptionCount, cameraActive, awaken, sleep, playWelcomeScript };
}
